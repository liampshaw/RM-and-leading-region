...
p.lines.density = ggplot(d.reduced.median.plot, aes(x, median.original*1000))+
  ...
  xlab("Position on plasmid (kb)")+
  theme(legend.position = c(0.8, 0.2))
ggsave(p.lines.density, file='../results/6mer-palindrome-density.pdf',
       width=10, height=6)
...
Now we want to correlate the GC content difference of the first 5kb of the plasmid with the difference in palindrome density
...
pdf('../results/GC-correlation-depletion.pdf', width=8, height=4)
